  ...
  return (
    ...
    <div>
      <div className='container'>
        ...
        <h1 id='name0fProfessor'>
          Hello <span>Professor</span>
        </h1>
        ...
        <div
          onclick="location='/VMAdmin_dash/addprofessor.html'"
          className='add_professor'
        >
          <span className='material-icons'>
        ...
        <div
          onClick="location='/vmutilization/utilization.html'"
          className='vm_utilization'
        >
          <span className='material-icons'>
